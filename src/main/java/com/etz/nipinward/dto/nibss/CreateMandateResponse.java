...
@ToString
@XmlRootElement(name = "CreateMandateResponse")
//@XmlType(propOrder = {"acctNumber","acctName", "transType", "bankCode", "billerID", "billerName","billerTransId","mandateCode","secondFactor","responseCode","hashValue"})
